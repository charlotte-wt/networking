...
client_socket.bind(('127.0.0.1', 5678))
...
if args.arp_a:
    ...
    if (destination_ip not in arp_cache):
        ...
        client_socket.sendto(arp_request, ('127.0.0.1', 8765))
        print("ARP Request sent from Node 1:", arp_request)
        ...
        # receive data from the socket
            ...
            if (bytes.fromhex("0x0806"[2:]) in data):
                ...
                client_socket.sendto(ether_frame, ('127.0.0.1', 8765))
    ...
    while True:
        ...
        response, _ = client_socket.recvfrom(8765)
        ...
        if (bytes.fromhex("0x0806"[2:]) in response):
            if (destination_ip_recv == source_ip):
                ...
                client_socket.sendto(arp_reply, ('127.0.0.1', 8765))
            else:
